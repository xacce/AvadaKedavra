...
{
    [BurstCompile]
    internal partial struct UpdateEmittersBufferedWithStripsJob : IJob
    {
        ...
        [WriteOnly] public NativeList<AvadaAliveBufferedStrips> aliveEffects;
        ...
        public void Execute()
        {
            ...
            while (requests.TryDequeue(out var request))
            {
                ...
                var alive = new AvadaAliveBufferedStrips()
                {
